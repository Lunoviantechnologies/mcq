...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-quiz-project-key-change-in-production')
...
if DB_ENGINE == 'mysql':
    # Production / RDS MySQL configuration (Option A)
    DATABASES = {
        'default': {
    ...
    # Default to SQLite for local development or if env vars not set
    DATABASES = {
        'default': {
